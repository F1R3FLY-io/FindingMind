...
| | |
|---|---|
| Chapters | 70 numbered, 5 unnumbered (the map, related work, three conclusion chapters), 4 interludes |
| Words | ~245,000 |
| Cross-references | 1,950 |
| Labels | 1,156 |
...
- Two passes: convert, then resolve. **All cross-references resolve. Zero dead.**
...
3. **The ledger.** All 597 results in one searchable, filterable list. The colour key is
   ...
   **red for conjectures and questions** — that is, for what the book has not established.
   There is a single button, *Show only what the book still owes*, which reduces the list
...
finding-mind/
  ...
  read/
    ...
    contact.html          comments form, relayed to f1r3fly.ceo@gmail.com
    ledger.html           the 573 results
    bibliography.html     242 entries
    nav.json, ledger.json
    01-prolegomena-to-finding-mind.html … 70-any-future-metaphysics.html
